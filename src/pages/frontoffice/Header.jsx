        ...
        <header className="navbar navbar-expand bg-white border-bottom px-4 py-3 sticky-top shadow-sm">
            <div className="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex gap-2">
                    ...
                    <a href="/myglpi/admin/login" className="btn btn-sm btn-secondary rounded-pill px-3 fw-medium" style={{ backgroundColor: "var(--bg-btn-primary)", borderColor: "var(--bg-btn-primary)" }}>
